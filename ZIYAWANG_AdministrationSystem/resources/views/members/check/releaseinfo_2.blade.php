                ...
                <div class="widget-content nopadding">
                    ...
                    @foreach($datas as $data)
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="AssetType" id="AssetList" value="{{$data->AssetType}}"readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">需求</label>
                            <div class="controls">
                                <input type="text" name="Requirement" id="Requirement" value="{{$data->Requirement}}"readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="member" id="member" value="0" @if($data->Member==0) checked="checked" @endif/>否
                                    <input type="radio" name="member"  id="member" value="1"  @if($data->Member==1) checked="checked" @endif />是
                                </div>
                            </div>
                        <div class="control-group">
