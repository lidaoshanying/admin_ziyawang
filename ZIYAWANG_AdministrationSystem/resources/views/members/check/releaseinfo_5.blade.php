                ...
                <div class="widget-content nopadding">
                    ...
                    @foreach($datas as $data)
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="AssetType" id="AssetType" value="{{$data->AssetType}}"
                                       readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">回报率</label>
                            <div class="controls">
                                <input type="text" name="Rote" id="Rote" value="{{$data->Rate}}" readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls  span3">
                                <div><img id="PictureDes1" alt=""
                                          @if(!empty($data->PictureDes1)) src="{{'Http://images.ziyawang.com'.$data->PictureDes1}}" @endif/>
                                       <span><a href="{{asset('Http://images.ziyawang.com'."$data->PictureDes1")}}"><i
                                                       class="icon-download PictureDes1"
                                                       @if(empty($data->PictureDes1)) style="display:none" @endif></i></a>&nbsp&nbsp
                                           <i class="icon-trash PictureDes1"
                                              @if(empty($data->PictureDes1)) style="display:none" @endif ></i>
                                       </span>
                                </div>
                                <div><img id="PictureDes2" alt=""
                                          @if(!empty($data->PictureDes2))  src="{{'Http://images.ziyawang.com'.$data->PictureDes2}}" @endif/>
                                        <span><a href="{{asset('Http://images.ziyawang.com'."$data->PictureDes2")}}"><i
                                                        class="icon-download PictureDes2"
                                                        @if(empty($data->PictureDes2)) style="display:none" @endif></i></a>&nbsp&nbsp
                                            <i class="icon-trash PictureDes2"
                                               @if(empty($data->PictureDes2)) style="display:none" @endif></i>
                                        </span>
                                </div>
                                <div><img id="PictureDes3" alt=""
                                          @if(!empty($data->PictureDes3))  src="{{'Http://images.ziyawang.com'.$data->PictureDes3}}" @endif/>
                                            <span><a href="{{asset('Http://images.ziyawang.com'."$data->PictureDes3")}}"><i
                                                            class="icon-download PictureDes3 "
                                                            @if(empty($data->PictureDes3)) style="display:none" @endif ></i></a>&nbsp&nbsp
                                                <i class="icon-trash PictureDes3"
                                                   @if(empty($data->PictureDes3)) style="display:none" @endif ></i>
                                            </span>
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="radio" name="member" id="member" value="0"
                                       @if($data->Member==0) checked="checked" @endif/>否
                                <input type="radio" name="member" id="member" value="1"
                                       @if($data->Member==1) checked="checked" @endif />是
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="#"><input type=button value="返回" class="btn btn-primary"
                                           onclick="javascript:history.back(-1);"/></a>
                    </div>
                    </form>
                </div>
            </div>
